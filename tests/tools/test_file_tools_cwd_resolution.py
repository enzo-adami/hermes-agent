...
# Per-test reset of terminal_tool._session_cwd / _task_env_overrides /
# _active_environments is centralised in tests/tools/conftest.py
# (_reset_terminal_task_state). The container tests below record a cwd under
# the shared "default" key; that reset is what keeps it out of every later
# test's resolution base.
